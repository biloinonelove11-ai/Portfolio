          ...
          >
            <div className="glass-card p-8">
              <p className="text-lg text-foreground/90 leading-relaxed mb-6">
                I am <span className="text-primary font-semibold">Samuel Girma</span>, a dedicated Software Engineer and Full Stack Developer with a strong background in penetration testing and competitive cybersecurity as a CTF player.
              </p>
