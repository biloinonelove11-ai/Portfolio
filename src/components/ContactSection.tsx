...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "girmasamuel200@gmail.com",
    href: "mailto:girmasamuel200@gmail.com",
    color: "primary",
  },
  {
    icon: Linkedin,
    label: "LinkedIn",
    value: "Samuel Girma",
    href: "https://www.linkedin.com/in/samuel-girma-442088296/",
    color: "secondary",
  },
  {
    icon: MessageCircle,
    label: "Telegram",
    value: "@Code_Architect01",
    href: "http://t.me/Code_Architect01",
    color: "accent",
  },
  {
    icon: Github,
